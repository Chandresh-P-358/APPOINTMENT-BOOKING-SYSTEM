...
<%
String keyword = request.getParameter("keyword"); AppointmentDAO dao = new AppointmentDAOImpl(); List<Appointment> list;
if (keyword != null && !keyword.isEmpty()) { list = dao.searchAppointment(keyword);
} else {
