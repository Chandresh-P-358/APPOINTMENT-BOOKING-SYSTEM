...
<input type="hidden" name="appointmentid" value="<%= a.getAppointmentId() %>"> Client Name:
<input type="text" name="clientname" value="<%= a.getClientName() %>" required> Service:
<input type="text" name="service" value="<%= a.getService() %>" required> Date:
<input type="date" name="date" value="<%= a.getDate() %>" required> Time:
